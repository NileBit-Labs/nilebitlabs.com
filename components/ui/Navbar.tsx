...
export default function Navbar() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      hasSubmenu: true,
      submenu: [
        { title: "Our Services", href: "/services#services" },
        { title: "Technologies", href: "/services#technologies" },
        { title: "Our Process", href: "/services#process" },
      ],
    },
    {
      title: "Portfolio",
      ...
      hasSubmenu: true,
      submenu: [
        { title: "Top Projects", href: "/solutions#featured-projects" },
        { title: "Blockchain Projects", href: "/solutions#blockchain" },
        { title: "AI & ML Projects", href: "/solutions#ai-ml" },
        { title: "Websites", href: "/solutions#websites" },
        { title: "Web applications", href: "/solutions#web-apps" },
        { title: "Mobile applications", href: "/solutions#mobile-apps" },
      ],
    },
    {
      title: "About Us",
